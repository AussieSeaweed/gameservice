...
class NoLimitTexasHoldEmSimulationTestCase(ExtendedTestCase, SimulationTestCaseMixin[NoLimitTexasHoldEm]):
    def test_not_betting_stage(self) -> None:
        self.assertRaises(ActionException, parse_poker(NoLimitTexasHoldEm(1, (1, 2), (200, 100)), (
        ...
        self.assertRaises(ActionException, parse_poker(NoLimitTexasHoldEm(1, (1, 2), (200, 100, 300, 200)), (
    ...
    def test_redundant_fold(self) -> None:
        self.assertRaises(ActionException, parse_poker, parse_poker(NoLimitTexasHoldEm(1, (1, 2), (200, 100)), (
        ...
        self.assertRaises(ActionException, parse_poker,
    ...
    def test_bet_amount(self) -> None:
        self.assertRaises(BetRaiseAmountException, parse_poker, parse_poker(NoLimitTexasHoldEm(1, (1, 2), (200, 100)), (
        ...
        self.assertRaises(BetRaiseAmountException, parse_poker,
                          parse_poker(NoLimitTexasHoldEm(1, (1, 2), (200, 100, 300, 200)), (
...
class PotLimitOmahaHoldEmSimulationTestCase(ExtendedTestCase, SimulationTestCaseMixin[PotLimitOmahaHoldEm]):
...
class NoLimitShortHoldEmTestCase(ExtendedTestCase, SimulationTestCaseMixin[NoLimitShortHoldEm]):
    def test_pre_flop(self) -> None:
        for game in (
                parse_poker(NoLimitShortHoldEm(3000, 3000, (495000, 232000, 362000, 403000, 301000, 204000)), (
    ...
    def test_hand(self) -> None:
        game = parse_poker(NoLimitShortHoldEm(3000, 3000, (495000, 232000, 362000, 403000, 301000, 204000)), (
            'dh 0 Th8h', 'dh 1 QsJd', 'dh 2 QhQd', 'dh 3 8d7c', 'dh 4 KhKs', 'dh 5 8c7h',
...
class FixedLimitGreekSimulationTestCase(TestCase, SimulationTestCaseMixin[FixedLimitGreekHoldEm]):
...
class NoLimitFiveCardDrawSimulationTestCase(TestCase, SimulationTestCaseMixin[NoLimitFiveCardDraw]):
...
class FixedLimitBadugiSimulationTestCase(TestCase, SimulationTestCaseMixin[FixedLimitBadugi]):
    def test_terminality(self) -> None:
...
class KuhnPokerSimulationTestCase(TestCase, SimulationTestCaseMixin[KuhnPoker]):
    def test_terminality(self) -> None:
        for game in (
