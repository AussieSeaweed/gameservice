"""
This module defines poker_ players in gameframe.
"""
...
class PokerPlayer(Player):
    """
    This is a class that represents poker_ players.
    """
    ...
    def mucked(self):
        """
        :return: a boolean value of whether or not the poker_ player has mucked
        """
    ...
    def commitment(self):
        """
        :return: the amount the poker_ player has put into the pot
        """
        return -self.payoff
    ...
    def total(self):
        """
        :return: the sum of the bet and the stack of the poker_ player
        """
    ...
    def effective_stack(self):
        """
        Finds the effective stack of the poker_ player.

        The effective stack denotes how much a player can lose in a pot.

        :return: the effective stack of the poker_ player
        """
    ...
    def relevant(self):
        """
        Finds the relevancy of the poker_ player.

        A poker_ player is relevant if he/she can make a bet/raise and there is at least one opponent who can call.

        :return: the relevancy of the poker_ player
        """
    ...
    def hand(self):
        """
        :return: the hand of the poker_ player if any hand is made else None
        """
...
class PokerNature(Nature):
    """
    This is a class that represents poker_ natures.
    """
