...
class PokerAction(SequentialAction, ABC):
    """
    This is a class that represents poker_ actions.
    """
...
class PokerPlayerAction(PokerAction, ABC):
    """
    This is a class that represents poker_ player actions.
    """
...
class PokerNatureAction(PokerAction, ABC):
    """
    This is a class that represents poker_ nature actions.
    """
...
class ShowdownAction(PokerNatureAction):
    ...
    This action exposes the poker_ player's hole cards if necessary and distributes the pot.
    """
